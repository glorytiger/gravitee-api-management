...
export class NotificationSettingsApplicationService {
  ...
  create(apiId: string, notificationConfig: NewNotificationSettings): Observable<NewNotificationSettings> {
    return this.http.post<NewNotificationSettings>(`${this.constants.env.baseURL}/applications/${apiId}/notificationsettings`, notificationConfig);
  }
  ...
  update(apiId: string, notificationId: string, notificationConfig: NotificationSettings): Observable<NotificationSettings> {
    return this.http.put<NotificationSettings>(
      `${this.constants.env.baseURL}/applications/${apiId}/notificationsettings/${notificationId}`,
      notificationConfig,
    );
  }
